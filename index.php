...
<div class="jumbotron jumbotron-fluid text-center" style="background-image: url(https://images.pexels.com/photos/1591062/pexels-photo-1591062.jpeg?auto=compress&cs=tinysrgb&h=750&w=1260)">
			  <div class="container">
				...
				<h2 >A SIMPLE EMAIL SOLUTIONS</h2>
				 ...
				 <h4>A cheap and effective webmail<br>solution for all your business needs...</h4>
			  </div>
			</div>
			
			
			<p id="text">If you are a new user , please register and create your user account. You need to know the your receipient user name to send email to him. Your receipient need to login to this server to get your email.</p>
