...
<table width="975" border="1" align="center" style="background-image:url('theme/<?php
  ...
  <tr  style="background-color:powderblue;">
    <td height="115" colspan="3" align="center" style="background-color:powderblue;">
...
?></div>
  ...
  <tr style="background-color:powderblue;">
    <td height="38" colspan="3" style="background-color:powderblue;">
  ...
  <tr style="background-color:powderblue;">
    <td width="158" height="572" valign="top" style="background-color:powderblue;">
    ...
    <td width="660" valign="top" style="background-color:powderblue;">
...
$dd=mysql_query($sql);
    ...
    <td width="135" style="background-color:powderblue;">&nbsp;</td>
  </tr>
  <tr style="background-color:powderblue;">
    <td height="47" colspan="3" style="background-color:powderblue;">
