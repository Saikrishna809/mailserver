...
<body bgcolor="#ccffff" style= "font-family: Calibri">
 ...
 <tr>    <td height="38" colspan="2">		<br>		<img src="images/logo1.PNG" alt="Logo" width="80" height="80" style="float:left"><br>		&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp  <a href="index.php">HOME</a>		&nbsp&nbsp&nbsp <a href="index.php?chk=about">ABOUT US</a>		&nbsp&nbsp&nbsp <a href="index.php?chk=login">LOGIN</a>		&nbsp&nbsp&nbsp <a href="index.php?chk=registraion">NEW USER?</a>		&nbsp&nbsp&nbsp <a href="index.php?chk=5"></a><br>		</td>  </tr><br><br>
<br><table width="100%" border="1" align="center" style="background-image:url('theme/<?php
...
?></div>
	 ...
	 <div style="float:left;margin-left:300px;padding-top:40px;font-size:25px;text-align:center;color:#660033;"> Welcome <?php  echo @$_SESSION['sid'];?>
	 </div>
 	  </td>
  </tr>
  <tr>
    <td height="38" colspan="3">
		...
		<a style="margin-left:50px" href="HomePage.php?chk=logout">LOGOUT</a> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
